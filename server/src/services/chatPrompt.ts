...
- Settings (everyone): edit your profile (nickname, full name, job title, avatar), choose the interface language (7 available), and pick a theme — Light, Dark, Violet, Image (your own background photo with an optional frosted "glass" effect), or Noir (a black/grey/white theme with an animated background and a cyan accent). Admins also find Backup & restore, the Store configuration, and the AI assistant configuration here.
